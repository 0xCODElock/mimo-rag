...
[![MiMo API](https://img.shields.io/badge/Powered%20by-MiMo%20API-orange)](https://100t.xiaomimimo.com/)
...
| `MIMO_MODEL` | `MiMo-7B-RL` | MiMo model to use |
...
MIT © 2024 [0xCODElock](https://github.com/0xCODElock)
